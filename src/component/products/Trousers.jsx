  ...
  return (
    <div>
        ...
        <section className="main">
            ...
            {searchParams.get('filter') === "" ? <h1 className="text-center text-uppercase">TROUSERS</h1> : <h1 className="text-center text-uppercase">TROUSERS FOR {searchParams.get('filter')}</h1> } 
