    ...
    <div>
        ...
        <section className="main">
            <div className="min-header stick-on-scroll">
                ...
                <button className={isMBtn ? "button-effect" : "button-men"} onClick={() => {setSearchParams({ filter: 'men'}), setMBtn(!isMBtn)}}>
                    Men
                </button>

                {/* <button className="font-weight-normal text-dark button-men" onClick={() => {setSearchParams({ filter: '' }), setABtn(!isABtn), setWBtn(false), setMBtn(false)}}>
                    All
                </button> */}
            </div> 

            {searchParams.get('filter') === "" ? <h1 className="text-center text-uppercase">BELTS</h1> : <h1 className="text-center text-uppercase">BELTS FOR {searchParams.get('filter')}</h1> } 
